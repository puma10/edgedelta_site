        ...
        <div class="max-width-custom1 align-center text-align-center">
          <div class="padding-bottom padding-medium">
            <h1 class="heading-style-h1-home">
              <span class="gradient-ai">Agentic Teammates</span>
            </h1>
...
<div class="section_trusted_engineers">
  <div class="padding-global">
    <div class="container-large">
      <div class="trusted_engineers_wrapper">
        <div class="trusted_engineers_header">
          <h3>TRUSTED BY ENGINEERS AT</h3>
        </div>
        
        <div class="trusted_engineers_logos">
          <!-- Row 1 -->
          <div class="logo_row">
            <div class="engineer_logo">
              <img src="<?php echo get_template_directory_uri() ?>/assets/images/slider/bugcrowd.svg" alt="Bugcrowd">
            </div>
            <div class="engineer_logo">
              <img src="<?php echo get_template_directory_uri() ?>/assets/images/slider/sinclair.png" alt="Sinclair">
            </div>
            <div class="engineer_logo">
              <img src="<?php echo get_template_directory_uri() ?>/assets/images/slider/panasonic.svg" alt="Panasonic">
            </div>
            <div class="engineer_logo">
              <img src="<?php echo get_template_directory_uri() ?>/assets/images/slider/taco-bell.svg" alt="Taco Bell">
            </div>
            <div class="engineer_logo">
              <img src="<?php echo get_template_directory_uri() ?>/assets/images/slider/american-airlines.svg" alt="American Airlines">
            </div>
          </div>
          ...
          <div class="logo_row">
            <div class="engineer_logo">
              <img src="<?php echo get_template_directory_uri() ?>/assets/images/slider/snowflake.svg" alt="Snowflake">
            </div>
            <div class="engineer_logo">
              <img src="<?php echo get_template_directory_uri() ?>/assets/images/slider/nvidia.svg" alt="NVIDIA">
            </div>
            <div class="engineer_logo">
              <img src="<?php echo get_template_directory_uri() ?>/assets/images/slider/boeing.svg" alt="Boeing">
            </div>
            <div class="engineer_logo">
              <img src="<?php echo get_template_directory_uri() ?>/assets/images/slider/box.svg" alt="Box">
            </div>
            <div class="engineer_logo">
              <img src="<?php echo get_template_directory_uri() ?>/assets/images/slider/webscale.svg" alt="Webscale">
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="padding-global">
    <div class="container-large is-lines lines-vertical">
      <div class="padding-section-xlarge">
        ...
        <div class="cursor_feature_block">
          <div class="cursor_feature_header">
            <h2 class="cursor_feature_title">Scale Your Security Operations</h2>
          </div>
          
          <div class="cursor_code_editor feature_gradient_4">
          ...
          <div class="cursor_feature_description">
            <p class="cursor_feature_subtitle">Deploy AI teammates that work across your entire tech stack, providing comprehensive coverage and intelligent automation for security operations.</p>
          </div>
        </div>
...
<div class="section_home_lottie" style="display: none;">
  <div class="padding-global">
    <div class="container-large is-dashes background-color-primary is-lines lines-vertical">
