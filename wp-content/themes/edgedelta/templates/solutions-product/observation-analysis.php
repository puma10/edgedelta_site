        ...
        <div class="container-large">
            <div class="padding-section-medium z-index-2">
                <div class="align-center text-align-center">
                    ...
                    <?php if (get_field('subtitle_analysis')) : ?>
                        <div class="padding-bottom padding-medium">
                            <div class="tag"><?php the_field('subtitle_analysis') ?></div>
                        </div>
                    <?php endif; ?>

                    <div class="padding-bottom padding-large">
                        <?php if (get_field('title_analysis')) : ?>
                            <div class="max-width-large align-center text-align-center padding-bottom padding-small">
                                <h2><?php the_field('title_analysis') ?></h2>
                            </div>
                        <?php endif; ?>

                        <?php if (get_field('desc_analysis')) : ?>
                            <div class="text-size-large text-weight-medium text-color-neutral-lighter"><?php the_field('desc_analysis') ?></div>
                        <?php endif; ?>
                    </div>

                    <?php $image_analysis = get_field('image_analysis') ?>
                    ...
                    <?php if (get_field('btn_text_analysis')) : ?>
                        <div class="display-inline">
                            <a data-w-id="979c967a-5e5b-ae25-ddbf-91efbcd566a4" href="<?php the_field('btn_url_analysis') ?>" class="button is-secondary w-inline-block">
                                <div class="text-size-medium"><?php the_field('btn_text_analysis') ?></div>
