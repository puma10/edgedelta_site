<?php if (get_field('title_analysis_2') || get_field('subtitle_analysis_2') || get_field('desc_analysis_2') || get_field('image_analysis_2')) : ?>
        ...
        <div class="container-large">
            <div class="padding-section-medium z-index-2">
                <div class="align-center text-align-center">
                    ...
                    <?php if (get_field('subtitle_analysis_2')) : ?>
                        <div class="padding-bottom padding-medium">
                            <div class="tag"><?php the_field('subtitle_analysis_2') ?></div>
                        </div>
                    <?php endif; ?>

                    <div class="padding-bottom padding-large">
                        <?php if (get_field('title_analysis_2')) : ?>
                            <div class="max-width-large align-center text-align-center padding-bottom padding-small">
                                <h2><?php the_field('title_analysis_2') ?></h2>
                            </div>
                        <?php endif; ?>

                        <?php if (get_field('desc_analysis_2')) : ?>
                            <div class="text-size-large text-weight-medium text-color-neutral-lighter"><?php the_field('desc_analysis_2') ?></div>
                        <?php endif; ?>
                    </div>

                    <?php $image_analysis_2 = get_field('image_analysis_2') ?>
                    <?php if ($image_analysis_2) : ?>
                    <div class="padding-bottom padding-large">
                        <div class="pipelines_image-wrapper">
                            <img src="<?php echo $image_analysis_2['sizes']['2048x2048'] ?>" sizes="(max-width: 479px) 91vw, (max-width: 767px) 95vw, (max-width: 991px) 92vw, 93vw" srcset="<?php echo $image_analysis_2['sizes']['medium_large'] ?> 800w, <?php echo $image_analysis_2['sizes']['large'] ?> 1080w, <?php echo $image_analysis_2['sizes']['1536x1536'] ?> 1600w, <?php echo $image_analysis_2['sizes']['2048x2048'] ?> 2518w" alt="<?php the_field('title_analysis_2') ?>" class="cover-img">
                        </div>
                    </div>
                    <?php endif; ?>

                    <div class="padding-bottom padding-custom3">
                        <?php if (have_rows('analysis_2')) : ?>
                            <div class="home_bullets">
                                <?php while (have_rows('analysis_2')) : the_row(); ?>
                    ...
                    <?php if (get_field('btn_text_analysis_2')) : ?>
                        <div class="display-inline">
                            <a data-w-id="979c967a-5e5b-ae25-ddbf-91efbcd566a4" href="<?php the_field('btn_url_analysis_2') ?>" class="button is-secondary w-inline-block">
                                <div class="text-size-medium"><?php the_field('btn_text_analysis_2') ?></div>
