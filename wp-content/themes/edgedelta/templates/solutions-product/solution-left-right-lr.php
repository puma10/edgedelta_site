<?php if (have_rows('solution_lf')) : ?>

    <?php $k = 0; ?>
    <?php $totalSolution = count(get_field('solution_lf')) ?>

    <?php while (have_rows('solution_lf')) : the_row(); ?>
        <?php $k++; ?>
        <div class="section_grid-2col">
            <div class="padding-global">
                <div class="container-large">
                    <div class="padding-section-medium" style="padding-top: 0">
                                                ...
                                                <?php while (have_rows('bullets')) : the_row(); ?>
                                                    <div class="grid_bullet">
                                                        ...
                                                        <?php if (get_sub_field('deciption')) : ?>
                                                            <div class="text-size-large text-weight-medium text-font-grotesk w-richtext"><?php the_sub_field('deciption') ?></div>
                                                        <?php endif ?>
                                                    </div>
                                                <?php endwhile; ?>
                                            </div>
