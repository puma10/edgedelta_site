<div role="listitem" class="integrations_item w-dyn-item">
    <div>

        <?php if (get_field('department')) : ?>
            <div class="padding-bottom padding-small">
                <div class="text-style-allcaps text-size-medium text-weight-medium text-color-green"><?php the_field('number_of_vacancies') ?> - <?php the_field('department') ?></div>
            </div>
        <?php endif ?>
        
        <div class="padding-bottom padding-medium">
            <div class="text-size-medium heading-style-h6-s"><?php the_title(); ?></div>
        </div>

        <div class="display-inline">
            <a href="<?php the_permalink(); ?>" class="button is-secondary is-small w-inline-block">
                <div class="text-size-medium">Details</div>
    ...
    <div class="careers_category">
        <div fs-cmsfilter-field="location" class="text-size-small">
            ...
            if (!empty($location)) {
                ...
                // Fallback to Remote if location is empty
                echo 'Remote';
            }
            ?>
        </div>
